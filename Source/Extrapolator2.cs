...
public class Extrapolator2 {
	...
	{
		Reset (packetTime, curTime, pos, Vector2.zero);
	}
...
//		assert(packetTime <= curTime);
	...
	private Vector2 snapPos_;
	private Vector2 snapVel_;
	private Vector2 aimPos_;
	private Vector2 lastPacketPos_;     //  only used when re-constituting velocity
